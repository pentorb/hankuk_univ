              ...
              <Collapse in={firstOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <Link to="/student/mypage" style={{ textDecoration: "none", color: 'black' }}>
                    <ListItemButton sx={{ pl: 4, borderRadius:10, width:180  }} selected={selectedIndex === 1} onClick={(e) => handleListItemClick(e, 1)}>
                      <ListItemText primary="상세보기" />
                    </ListItemButton>
                  </Link>
                  <Link to="/student/regHuehak" style={{ textDecoration: "none", color: 'black' }}>
                    <ListItemButton sx={{ pl: 4, borderRadius:10, width:180  }} selected={selectedIndex === 2} onClick={(e) => handleListItemClick(e, 2)}>
              ...
              <Collapse in={thirdOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  <Link to="/student/my-grade" style={{ textDecoration: "none", color: "black" }}>
                    <ListItemButton sx={{ pl: 2, borderRadius:10, width:180 }} selected={selectedIndex === 7} onClick={(e) => handleListItemClick(e, 7)}>
          ...
          {activeTab === 3 &&
            <>
              <Link to="/student/calendar" style={{ textDecoration: "none", color: "black" }}>
                <ListItemButton selected={selectedIndex === 12} onClick={(e) => handleListItemClick(e, 12)} sx={{borderRadius:10, width:180}}>
                  <ListItemText primary="일정 조회"  sx={{pl:1}}/>
                </ListItemButton>
              </Link>
              <Link to="/student/insert-calendar" style={{ textDecoration: "none", color: "black" }}>
                <ListItemButton selected={selectedIndex === 13} onClick={(e) => handleListItemClick(e, 13)} sx={{borderRadius:10, width:180}}>
